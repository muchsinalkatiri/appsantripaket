...
<div class="row ">
	<div class="col-lg-12">
		<div class="card shadow mb-7">
			...
			<div class="card-body">
				<form class="user" action="<?php echo base_url('user/create_user') ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12" >
						...
						<div class="col-sm-12">
							...
							<div class="form-group row">
								<div class="col-sm-6 mb-3 mb-sm-0">
									<input type="text" class="form-control form-control-user" value="<?php echo set_value('nama_user'); ?>" id="nama_user" placeholder="Nama User" name="nama_user">
								</div>
								<div class="col-sm-6">
							...
							<div class="form-group row">
								<div class="col-sm-6 mb-3 mb-sm-0">
									<input type="password" class="form-control form-control-user"  id="notlp2" value="<?php echo set_value('password'); ?>" name="password" placeholder="Passsword...">
								</div>
								<div class="col-sm-6" >
								   ...
								   <?php                                
								        foreach ($user as $data_user) {  
										  echo "<option value='".$data_user->id_role."'>".$data_user->nama_role."</option>";
										  }
										  echo"
										</select>"
										?>
