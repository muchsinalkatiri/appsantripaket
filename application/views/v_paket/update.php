...
<nav aria-label="breadcrumb"> <!-- buka breadcumb -->
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Update Data Paket</li>
  </ol>
</nav> <!-- tutup breadcumb -->
...
<div class="row ">
	<div class="col-lg-12">
		<div class="card shadow mb-7">
			...
			<div class="card-body">
				<form class="user" action="<?php echo base_url('paket/update/'.$paket->id_paket) ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12" >
						...
						<div class="col-sm-8">
							...
							<div class="form-group row">
								<div class="col-sm-6 mb-3 mb-sm-0">
									<input type="text" class="form-control" value="<?php echo $paket->nama_paket; ?>" id="nama_paket" placeholder="Nama Paket" name="nama_paket">
								</div>
								<div class="col-sm-6">
									<input type="text" class="form-control time" value="<?php echo $paket->tanggal_diterima; ?>" id="tanggal_diterima" name="tanggal_diterima" placeholder="Tanggal Diterima">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6 ">
									<input type="text" class="form-control" value="<?php echo $paket->pengirim_paket; ?>" id="pengirim_paket" name="pengirim_paket" placeholder="Pengirim Paket">
								</div>
							</div>
							...
							<div class="form-group row">
								<div class="col-sm-6 ">
									<input type="text" class="form-control" value="<?php echo $paket->isi_paket_sita; ?>" id="isi_paket_sita" name="isi_paket_sita" placeholder="Isi Paket Sita Paket">
								</div>
								<div class="col-sm-6" >
